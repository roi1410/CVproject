...
const PDFContext = ({ children }) => {
  ...
  const [state, dispatch] = useReducer(PDFredocer, defultValue);
  ...
  useEffect(() => {
    ...
    dispatch({
      ...
      primaryPosition: debouncedValue.primaryPosition,
    });
    dispatch({
      type: "aboutDescriptionChange",
      aboutDescription: debouncedValue.aboutDescription,
    });
    dispatch({
      type: "contactInfoChange",
      contactInfo: { tel: debouncedValue.tel, email: debouncedValue.email,address: debouncedValue.address, },
    });
  //   dispatch({ type: "educationChange",  education: [
  //     {
  //       period: debouncedValue.period,
  //       titled: debouncedValue.titled,
  //       awarded: debouncedValue.awarded
  //     }
  //   ]
  // });
